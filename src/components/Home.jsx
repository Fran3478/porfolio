  ...
  return (
    <div id='home' className="bg-[#062446] flex max-w-screen min-h-screen max-h-fit h-screen flex-col md:flex-row overflow-hidden">
      ...
      <div className="flex md:flex-col justify-center md:justify-normal bg-transparent w-full h-1/3 md:h-full md:w-1/3 relative select-none">
        ...
        <div className="absolute -top-1/4 sm:-top-20 md:-left-[15%] md:top-[calc(50%-10rem)] rounded-full border-8 border-[#65a3f2] bg-[#416B9A] overflow-hidden">
          <img className="pointer-events-none w-[12rem] h-[12rem] lg:w-[17rem] xl:w-[20rem] lg:h-[17rem] xl:h-[20rem] aspect-square object-cover" src="https://res.cloudinary.com/dacbde3so/image/upload/v1710809019/portfolio-img/jhxhwyvlwl73to5ny4la.webp" alt="photo" />
        </div>
      </div>
    </div>
  )
