...
const Status = ({ status }) => {
    return (
        <div className={`select-none ${status.control === "finished" ? "bg-green-600 text-green-200" : status.control === "on development" && "bg-yellow-500 text-yellow-100"} rounded-full w-fit flex my-[0.4rem] self-end py-[0.2rem]`}>
