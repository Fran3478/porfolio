...
const Status = ({ status }) => {
    return (
        <div className={`${status.control === "finished" ? "bg-green-600 text-green-200" : status.control === "on development" && "bg-yellow-500 text-yellow-100"} rounded-full w-fit flex my-2 mr-3 self-end py-[0.2rem]`}>
